...
namespace CardGameDemoDB
{
    public class DeckPlayer2
    {
        ...
        public DeckPlayer2 AddToDeck2(DeckPlayer1 card)
        {
            //DeckPlayer2 newCard = new DeckPlayer2();
        ...
        public void GetCardInfo(DeckPlayer2 deckPlayer2, string id, Database demodb)
        {

            deckPlayer2.Card_id = id;
            ...
            if (reader.Read())
            {
                ...
                deckPlayer2.Card_name = reader.GetString(0);
                deckPlayer2.Damage = reader.GetInt32(1);
                deckPlayer2.Card_type = reader.GetString(2);
                deckPlayer2.Element = reader.GetString(3);
                deckPlayer2.Species = reader.GetString(4);

            }
            reader.Close();

            Console.WriteLine("Id: " + deckPlayer2.Card_id);
            Console.WriteLine("Cardname: " + deckPlayer2.Card_name);
            Console.WriteLine("Damage: " + deckPlayer2.Damage);
            Console.WriteLine("Card type: " + deckPlayer2.Card_type);
            Console.WriteLine("Element: " + deckPlayer2.Element);
            Console.WriteLine("Species: " + deckPlayer2.Species);
